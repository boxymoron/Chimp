App.Database = function(name, schema) {
		...
		function init(callback){
			...
			var fn = function (transaction) {
				...
				var rssFeeds = ['http://feeds.arstechnica.com/arstechnica/index?format=xml', 'http://rss.slashdot.org/Slashdot/slashdotLinux', 'http://rss.slashdot.org/Slashdot/slashdotPolitics','http://rss.slashdot.org/Slashdot/slashdotDevelopers','http://rss.slashdot.org/Slashdot/slashdotYourRightsOnline','http://rss.cnn.com/rss/cnn_topstories.rss','http://www.npr.org/rss/rss.php?id=1001'];
